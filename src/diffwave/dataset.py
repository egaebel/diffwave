...
class NumpyDataset(torch.utils.data.Dataset):
    def __init__(self, paths, spec_filename_suffix=".wav.spec.npy"):
        super().__init__()
    ...
    def __getitem__(self, idx):
        ...
        return {"audio": signal[0] / 32767.5, "spectrogram": spectrogram.T}
...
def from_path(
    data_dirs, params, is_distributed=False, spec_filename_suffix=None,
):
    if spec_filename_suffix is None:
        dataset = NumpyDataset(data_dirs)
    else:
        dataset = NumpyDataset(data_dirs, spec_filename_suffix=spec_filename_suffix)
